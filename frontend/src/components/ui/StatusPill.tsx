...
const DARK_STATUS_MAP: Record<string, { label: string; text: string; bg: string; border: string; dot: string }> = {
  ...
  LEAD_APPROVAL:  { label: 'Lead Approval',  text: 'text-sky-400',      bg: 'bg-sky-500/10',        border: 'border-sky-500/30',       dot: 'bg-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.5)] animate-pulse' },
  LEAD_RETAKE:    { label: 'Lead Retake',    text: 'text-rose-400',     bg: 'bg-rose-500/15',       border: 'border-rose-500/40',      dot: 'bg-rose-400 shadow-[0_0_8px_rgba(244,63,94,0.5)] animate-pulse' },
